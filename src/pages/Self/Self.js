  ...
  return (
    <div className="self-wrapper">
      <div className="self-intro">
        <img src={img} className="self-pic" alt="a headshot of me!" />
        <div className="self-text">
          <p className="self-heading">Hi, I'm Huzaifa.</p>
          <br />
          <p>
            I'm currently in my Final Year of Study in{' '}
            <i>Bachelor of Technology in Artificial Intelligence and Data Science</i>{' '}
          ...
          <p>
            ...
            coding, experimenting, building, spending time with friends, etc. Currently
            working on building projects, aiming to get an internship (and possibly a job)
            in ML related field. Feel free to reach out if you're 'THE GUY'!
          </p>
          <br />
          <p>
          ...
          <div className="self-info">
            <div>
              ...
              <br />
              <p><b>Things I enjoy:</b> Solving Sudoku,
                curating{' '}
              ...
              <ul>
                ...
                <li><b>Artists</b>: Coldplay, The 1975, Fred Again, The Plot in You, The Weeknd,
                  ...
                  Arctic Monkeys, Cigarettes After Sex, Kanye West, Kendrick Lamar</li>
